package com.example.finalmerge.POStRequirementsQuiz.inStreamQuiz.inStream_CS.inStream_CS_minor;
...
public class inStreamCSminorQuiz extends AppCompatActivity implements View.OnClickListener{
    ...
    Button back_btn;
    Button home_btn;
    int totalQuestion = inStreamCSminorQuiz_QuestionAnswer.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalQuestionsTextView.setText("InStream > CS > Minor");
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            ...
            if(!selectedAnswer.equals(inStreamCSminorQuiz_QuestionAnswer.correctAnswers[currentQuestionIndex])){
                finishQuiz_fail();
                return;
            }
            currentQuestionIndex++;
            if (currentQuestionIndex < inStreamCSminorQuiz_QuestionAnswer.question.length) {
                loadNewQuestion();
            }
            else {
...
//            clickedButton.setBackgroundTintList(ColorStateList.valueOf(Color.BLUE));
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(inStreamCSminorQuiz_QuestionAnswer.question[currentQuestionIndex]);
        ans_A.setText(inStreamCSminorQuiz_QuestionAnswer.choices[currentQuestionIndex][0]);
        ans_B.setText(inStreamCSminorQuiz_QuestionAnswer.choices[currentQuestionIndex][1]);
    }
...
//        loadNewQuestion();
        Intent returnPostMenu = new Intent(inStreamCSminorQuiz.this, POStMenu_ver2.class);
    ...
    void finishQuiz_home(){
        currentQuestionIndex=0;
        Intent returnHome = new Intent(inStreamCSminorQuiz.this, homePage.class);
        startActivity((returnHome));
        finish();
    }
    void finishQuiz_back(){
        Intent returnPostMenu = new Intent(inStreamCSminorQuiz.this, inStreamCSdiffQuiz.class);
        startActivity(returnPostMenu);
